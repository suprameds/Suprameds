        ...
        <div className="max-w-3xl flex flex-col gap-6">
          ...
          {[
            ...
            },
            {
              ...
              <ol class="mt-2 space-y-2">
                <li>1. Contact us within 48 hours of delivery via WhatsApp (+91 76749 62758) or email suprameds@gmail.com</li>
          ...
          <div className="p-5 rounded-xl" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-primary)" }}>
            ...
            <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
              Contact us: <a href="tel:+917674962758" className="font-medium" style={{ color: "var(--brand-teal)" }}>+91 76749 62758</a> or email <a href="mailto:suprameds@gmail.com" className="font-medium" style={{ color: "var(--brand-teal)" }}>suprameds@gmail.com</a>
            </p>
