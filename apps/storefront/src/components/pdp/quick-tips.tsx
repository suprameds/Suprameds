  ...
  return (
    <div className="rounded-lg overflow-hidden" style={{ background: "#F0FDF4", border: "1px solid #BBF7D0" }}>
      <div className="px-4 py-3 flex items-center gap-2" style={{ borderBottom: "1px solid #BBF7D0" }}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--price-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ul className="px-4 py-3 flex flex-col gap-2">
        {tips.map((tip, i) => (
          <li key={i} className="flex items-start gap-2.5 text-sm" style={{ color: "var(--text-primary)" }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--price-color)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0 mt-0.5">
