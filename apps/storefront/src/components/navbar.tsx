        ...
        <nav className="content-container flex items-center gap-x-4 w-full h-16">
          ...
          >
            <img
              ...
              className="h-11 dark:[filter:brightness(0)_invert(1)]"
          ...
          {!isNativeApp() && <Drawer>
            ...
            <DrawerContent side="left">
              <DrawerHeader>
                <DrawerTitle>
                  <img src="/images/suprameds-logo-full.png" alt="Suprameds" className="h-10 dark:[filter:brightness(0)_invert(1)]" style={{ objectFit: "contain" }} />
                </DrawerTitle>
              </DrawerHeader>
          ...
          <div className="lg:hidden flex-1 flex justify-center">
            ...
            >
              <img
                src="/images/suprameds-logo-full.png"
                alt="Suprameds"
                className="h-10 dark:[filter:brightness(0)_invert(1)]"
                style={{ objectFit: "contain" }}
              />
            </Link>
          </div>
